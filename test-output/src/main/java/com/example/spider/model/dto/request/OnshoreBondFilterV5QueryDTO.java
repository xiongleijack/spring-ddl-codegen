package com.example.spider.model.dto.request;
...
/**
 * 境内债券筛选V3宽表（旧onshore_bond_filter超集+F9/DeepInfo/list复刻字段），每个bondUniCode一行，软删，update_time为增量游标表Query对象 {@link OnshoreBondFilterV5DO}
 *
 * @author xionglei
 */
public class OnshoreBondFilterV5QueryDTO {
