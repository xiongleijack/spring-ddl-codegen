package com.example.spider.controller.internal;
...
/**
 * internal 境内债券筛选V3宽表（旧onshore_bond_filter超集+F9/DeepInfo/list复刻字段），每个bondUniCode一行，软删，update_time为增量游标内部接口
 *
 * @author xionglei
 */
@Api(tags = "(内部)境内债券筛选V3宽表（旧onshore_bond_filter超集+F9/DeepInfo/list复刻字段），每个bondUniCode一行，软删，update_time为增量游标")
@RestController
@RequestMapping("/internal/onshoreBondFilterV5")
public class InternalOnshoreBondFilterV5Controller {
    ...
    @ApiOperation("新增")
    @PostMapping
    public void insertOnshoreBondFilterV5(
    ...
    @ApiOperation("更新")
    @PutMapping
    public void updateOnshoreBondFilterV5(
            @ApiParam(value = "用户id") @CookieValue(value = "m_user_id", defaultValue = "1") Long userId,
            @RequestBody OnshoreBondFilterV5DetailDTO onshoreBondFilterV5DetailDTO) {
    ...
    @ApiOperation("根据ID查询")
    @GetMapping
    public OnshoreBondFilterV5DetailDTO getOnshoreBondFilterV5ById(@RequestParam Long id) {
        return onshoreBondFilterV5Service.getOnshoreBondFilterV5ById(id);
    }
    ...
    public NormPagingResult<OnshoreBondFilterV5PageDTO> pageQuery(
        ...
        return onshoreBondFilterV5Service.pageQuery(
